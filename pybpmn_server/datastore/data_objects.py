...
if TYPE_CHECKING:
    ...
    from pybpmn_server.interfaces.enums import ExecutionStatus, TokenStatus
...
class ItemData(BaseModel):
    ...
    instance_id: str = Field(description="Instance Id this item belongs to")
    user_name: str = Field(description="User who started the item")
    ...
    assignee: Optional[SecureUser] = Field(default=None)
    candidate_groups: List[str] = Field(default_factory=list)
    candidate_users: List[SecureUser] = Field(default_factory=list)
