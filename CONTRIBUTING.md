...
This project and everyone participating is governed by the [PyBPMN Server Code of Conduct](../CODE_OF_CONDUCT.md).
...
This section guides you through submitting an enhancement suggestion for PyBPMN Server, including entirely new features and minor improvements to existing functionality. Following these guidelines will help maintainers and the community understand your suggestions and find related suggestions.
...
```console
$ git clone https://github.com/callowayproject/pybpmn-server.git
...
[documentation]: https://callowayproject.github.io/pybpmn-server/
[new_issue]: https://github.com/callowayproject/pybpmn-server/issues/new
[issues]: https://github.com/callowayproject/pybpmn-server/issues
